...
execute as @a unless score @s mojodice.event.keep_highest matches 0 \
    run function mojodice:events/keep_highest/handler
scoreboard players enable @a mojodice.event.keep_highest

execute as @a unless score @s mojodice.event.keep_lowest matches 0 \
    run function mojodice:events/keep_lowest/handler
scoreboard players enable @a mojodice.event.keep_lowest
